...
write_filename = "final_knockaround_" + date_now + ".csv"
...
if __name__ == "__main__":
	...
	stealth_sync(page)
	start_url = "https://knockaround.com/collections/sunglasses-sale"
	page.goto(start_url, wait_until="load")
	input('Enter if done scrolling: ')

	try:
		soup = BeautifulSoup(page.content(), "html.parser")
		for item in soup.find('div', id='ProductGridContainer').find('motion-list').find_all('div', class_='product-card--standard'):
			urls.append('https://knockaround.com'+item.find('a')['href'])
	finally:
		context.close()
		browser.close()
		p.stop()
