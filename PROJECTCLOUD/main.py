...
write_filename = "final_projectcloud_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://projectcloudshoes.com/collections/footwear-sale-limited-time?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('grid-list', id='ProductsList').find_all('div', class_='f-column'):
		urls.append('https://projectcloudshoes.com'+item.find('a')['href'])
...
if __name__ == "__main__":
	...
	total_pages = math.ceil(int(get_pages)/16)
