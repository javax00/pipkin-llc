...
write_filename = "final_ogee_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://ogee.com/collections/ogee-x-discount-code-collection?ll_ref_id=onyj2jySZ&page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('ul', id='product-grid').find_all('li', class_='grid__item'):
		urls.append('https://ogee.com'+item.find('a')['href'])
