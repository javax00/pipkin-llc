...
write_filename = "final_zulily_" + date_now + ".csv"
...
def get_product_links(page):
	# url = f'https://www.zulily.com/collections/flashsale-anti-aging-device-and-more?page={page}'
	# url = f'https://www.zulily.com/collections/flashsale-h-birkenstock-new-arrivals?page={page}'
	# url = f'https://www.zulily.com/collections/flashsale-l-ray-ban-oakley-sunglasses-best-of-summer?page={page}'
	url = f'https://www.zulily.com/collections/adidas-sales-event?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('ul', id='product-grid').find_all('li', class_='grid__item'):
		urls.append('https://www.zulily.com'+item.find('a')['href'])
