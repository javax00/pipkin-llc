...
write_filename = "final_omcgear_" + date_now + ".csv"
...
def get_product_links(page):
	global urls
	url = f'https://omcgear.com/collections/sales?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')
	
	products = soup.find('ul', id='product-grid').find_all('li', class_='grid__item')
	for product in products:
		urls.append('https://omcgear.com'+product.find('a', class_='full-unstyled-link').get('href'))   
