...
write_filename = "final_gramophone_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://skybygramophone.com/collections/sale?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('div', class_='main-filter-content').find_all('div', class_='grid__item'):
		urls.append('https://skybygramophone.com'+item.find('a')['href'].split('?')[0].strip())
