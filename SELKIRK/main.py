...
write_filename = "final_selkirk_" + date_now + ".csv"
...
def get_product_links(url):
	...
	for item in soup.find('div', id='shopify-section-collection').find_all('div', class_='product-card'):
		urls.append('https://www.selkirk.com'+item.find('a')['href'].split('?')[0])
...
if __name__ == "__main__":
	get_product_links('https://www.selkirk.com/collections/featured-deals')
