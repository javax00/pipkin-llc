...
write_filename = "final_cultpens_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://cultpens.com/collections/clearance?productListPgNo={page}'
	html = get_zenrows_html(url, 'div.kuResults')
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('div', class_='kuResults').find('ul').find_all('li', class_='klevuProduct'):
