...
write_filename = "final_baristaunderground_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://www.baristaunderground.com/collections/syrups?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('div', class_='product-grid').find_all('product-block'):
		urls.append('https://www.baristaunderground.com'+item.find('a')['href'])
