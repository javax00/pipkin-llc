...
write_filename = "final_matissefootwear_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://www.matissefootwear.com/collections/sale?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('div', class_='gsProductImages').find_all('span'):
		url = 'https://www.matissefootwear.com/collections/sale/products/'+item.get('gsproducthandle')
		if url not in urls:
			urls.append(url)
