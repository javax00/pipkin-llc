...
write_filename = "final_puravida_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://www.puravidabracelets.com/collections/sale?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('div', class_='xl:grid-cols-4').find_all('product-card'):
		urls.append('https://www.puravidabracelets.com'+item.find('a')['href'].split('?')[0])
