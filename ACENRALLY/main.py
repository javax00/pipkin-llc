...
write_filename = "final_acenrally_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://acenrally.com/collections/savings?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('div', class_='product-list--collection').find_all('div', class_='product-item--vertical'):
		urls.append('https://acenrally.com'+item.find('a')['href'])
