...
write_filename = "final_hardypaw_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://hardypaw.com/collections/labor-day-sale?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('div', id='collection-products').find_all('div', class_='product-rows'):
		urls.append('https://hardypaw.com'+item.find('a')['href'])
