...
write_filename = "final_hotel_collection_" + date_now + ".csv"
write_headers = ['UPC', 'Price', 'Variant', 'Source URL']
############################# CSV WRITE #################################
...
def get_product_links(page):
	url = f'https://www.hotelcollection.com/collections/first-class?page={page}'
	html = get_zenrows_html(url, 'product-list.product-list')
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('product-list', class_='product-list').find_all('product-card', class_='product-card'):
		urls.append('https://www.hotelcollection.com'+item.find('a')['href'])
