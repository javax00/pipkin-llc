...
write_filename = "final_solidandstriped_" + date_now + ".csv"
...
def get_product_links(page):
	# url = f'https://www.solidandstriped.com/collections/sale?page={page}'
	url = f'https://www.solidandstriped.com/collections/shop-all?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('div', class_='sf__product-listing').find_all('div', class_='sf_product_card'):
		urls.append('https://www.solidandstriped.com'+item.find('a')['href'])
