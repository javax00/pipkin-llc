...
write_filename = "final_originalpenguin_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://www.originalpenguin.com/collections/clearance?page={page}'
	...
	for item in soup.find('div', class_='boost-sd__product-list').find_all('div', class_='boost-sd__product-item'):
		urls.append('https://www.originalpenguin.com'+item.find('a')['href'])
