...
write_filename = "final_kwikpets_" + date_now + ".csv"
...
def get_product_links(page):
	# url = 'https://www.kwikpets.com/collections/eye-ear-care'
	# url = 'https://www.kwikpets.com/collections/aqueon'
	# url = 'https://www.kwikpets.com/collections/four-paws'
	url = 'https://www.kwikpets.com/collections/all-products'
	url = f'{url}?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('ul', id='product-grid').find_all('li', class_='grid__item'):
		urls.append('https://www.kwikpets.com'+item.find('a')['href'])
