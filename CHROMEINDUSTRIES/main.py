...
write_filename = "final_chromeindustries_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://chromeindustries.com/collections/sale?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('product-list', class_='product-list').find_all('product-card'):
		urls.append('https://chromeindustries.com'+item.find('a')['href'])
