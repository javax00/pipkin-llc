...
write_filename = "final_hexclad_" + date_now + ".csv"
...
def get_product_links():
	url = f'https://hexclad.com/pages/end-of-summer-sale'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find_all('section', class_='js-collection-sale-grid'):
		for i in item.find_all('div', class_='mod_collection_sale_grid_o5JRja_Card'):
			url = 'https://hexclad.com'+i.find('a')['href']
			urls.append(url)
