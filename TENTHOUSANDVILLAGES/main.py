...
write_filename = "final_tenthousandvillages_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://www.tenthousandvillages.com/collections/markdowns?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('ul', class_='productgrid--items').find_all('div', class_='productgrid--item'):
		urls.append('https://www.tenthousandvillages.com'+item.find('a', class_='productitem--image-link')['href'])
