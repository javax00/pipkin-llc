...
write_filename = "final_wildboutique_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://9c1375.a.searchspring.io/api/search/search.json?lastViewed=STEXSRIS55961%2CSIMSPSMBE%2058725&userId=12227018-d674-48fd-8acf-58c397ef9dce&domain=https%3A%2F%2Fwww.wildoakboutique.com%2Fcollections%2Fsale%3Fpage%3D2&sessionId=013e021e-9f5c-4164-863a-6e78dbf520fe&pageLoadId=1e36348c-54b1-4a77-a8e6-8adc75a87187&siteId=9c1375&page={page}&intellisuggest=false&bgfilter.collection_handle=sale&redirectResponse=full&noBeacon=true&ajaxCatalog=Snap&resultsFormat=native'
	html = get_zenrows_html(url)
	json_data = json.loads(html)

	for item in json_data['results']:
		urls.append('https://www.wildoakboutique.com'+item['url'])
