...
write_filename = "final_dkny_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://www.dkny.com/collections/summer-essentials?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('div', class_='collection--body--grid').find_all('ul', class_='product-tile-root'):
		urls.append('https://www.dkny.com'+item.find('a')['href'])
