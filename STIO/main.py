...
write_filename = "final_stio_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://www.stio.com/collections/sale?count={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	print(soup.find('div', class_='cl_products'))

	for item in soup.find('div', class_='cl_products').find_all('div', class_='pc__wrapper'):
		urls.append('https://www.stio.com'+item.find('a')['href'])
...
if __name__ == "__main__":
	...
	start_url = "https://www.stio.com/collections/sale?count=122"
	...
	try:
		...
		for item in soup.find('div', class_='cl_products').find_all('div', class_='pc__wrapper'):
			urls.append('https://www.stio.com'+item.find('a')['href'].split('?')[0])
	finally:
		context.close()
		browser.close()
		p.stop()
