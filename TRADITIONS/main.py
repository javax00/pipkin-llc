...
write_filename = "final_traditions_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://store.traditionsweb.com/clearance/page{page}.html'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find_all('div', class_='product-block-holder'):
...
def get_product_info(link):
	...
	upc = soup.find('meta', {'itemprop': 'gtin13'})['content']
