...
write_filename = "final_fashioneyewear_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://www.fashioneyewear.com/en-us/collections/sale?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('div', class_='grid--uniform').find_all('div', class_='grid__item'):
		urls.append('https://www.fashioneyewear.com'+item.find('a')['href'].split('?')[0])
