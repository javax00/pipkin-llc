...
write_filename = "final_tozo_" + date_now + ".csv"
...
def get_product_links(url):
	...
	products = soup.find_all('div', class_='product__imageContainer')
	for product in products:
		urls.append('https://www.tozostore.com'+product.find('a').get('href'))   
...
if __name__ == "__main__":
	url = 'https://www.tozostore.com/pages/summer-sale'
