...
write_filename = "final_nicekicks_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://shopnicekicks.com/collections/sale?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find_all('div', class_='ProductItem__Wrapper'):
		url = 'https://shopnicekicks.com'+item.find('a')['href']
		if url not in urls:
			urls.append(url)
