...
write_filename = "final_universalstandard_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://www.universalstandard.com/collections/summer-markdowns?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('div', class_='collectionGridItems').find_all('div', class_='collectionItem'):
		url = 'https://www.universalstandard.com'+item.find('a')['href']
		if url not in urls:
			urls.append(url)
