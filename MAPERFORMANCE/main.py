...
write_filename = "final_maperformance_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://www.maperformance.com/collections/inventory-clearance?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('div', id='main-collection-product-grid').find_all('div', class_='product-item'):
		urls.append('https://www.maperformance.com'+item.find('a')['href'])
