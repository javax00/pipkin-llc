...
write_filename = "final_mnml_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://mnml.la/collections/retiring-styles?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('div', id='productGrid').find_all('div', class_='product-card'):
		urls.append('https://mnml.la'+item.find('a')['href'])
