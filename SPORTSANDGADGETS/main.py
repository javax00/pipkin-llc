...
write_filename = "final_sportsandgadgets_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://www.sports-and-gadgets.com/collections/sale-sale-sale?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('div', class_='products-grid').find_all('div', class_='product'):
		urls.append('https://www.sports-and-gadgets.com'+item.find('a')['href'].split('?')[0])
