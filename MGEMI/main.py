...
write_filename = "final_mgemi_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://mgemi.com/collections/before-they-go?view=json&page={page}'
	html = get_zenrows_html(url)
	data = json.loads(html)

	for item in data['productSets']:
		for var in data['productSets'][item]:
			urls.append('https://mgemi.com/products/'+var['handle'])
