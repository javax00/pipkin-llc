...
write_filename = "final_oofos_" + date_now + ".csv"
...
def get_product_links(url):
	...
	for item in data['products']:
		urls.append('https://www.oofos.com/products/'+item['handle'])
...
if __name__ == "__main__":
	get_product_links('https://www.oofos.com/collections/sale?view=json')
