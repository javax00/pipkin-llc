...
write_filename = "final_citizenry_" + date_now + ".csv"
...
def get_product_links(page):
	html = get_zenrows_html(page)
	soup = BeautifulSoup(html, 'html.parser')

	data = soup.find('script').get_text()
	data = json.loads(data)
	
	for product in data['products']:
		urls.append('https://www.the-citizenry.com'+product['url'])
...
if __name__ == "__main__":
	# url = 'https://www.the-citizenry.com/collections/all-best-sellers?view=json'
	url = 'https://www.the-citizenry.com/collections/archive-sale?view=json'
