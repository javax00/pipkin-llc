...
write_filename = "final_toolup_" + date_now + ".csv"
...
def get_product_links(page):
	global urls
	# url = 'https://toolup.com/collections/bogo-deals'
	# url = 'https://toolup.com/collections/milwaukee-circular-saw-blades'
	# url = 'https://toolup.com/collections/ridgid-summer-savings'
	# url = 'https://toolup.com/collections/milwaukee-top-deals'
	# url = 'https://toolup.com/collections/dewalt-top-deals'
	url = 'https://toolup.com/collections/makita-top-deals'
	url = f'{url}?page={page}'
