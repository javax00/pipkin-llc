...
write_filename = "final_bulletproof_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://shop.bulletproof.com/collections/labor-day-sale?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('div', class_='product-card-grid--plp').find_all('div', class_='collection__product'):
		urls.append('https://shop.bulletproof.com'+item.find('a')['href'])
