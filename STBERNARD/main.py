...
write_filename = "final_stbernard_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://ouh4zj.a.searchspring.io/api/search/search.json?lastViewed=1544238&userId=7d14f14b-a064-4574-a88f-f50ee15d403d&domain=https%3A%2F%2Fwww.saintbernard.com%2Fcollections%2Fsale%3Fpage%3D{page}&sessionId=4af079ab-4fc7-4a9c-a2a0-566791956b8e&pageLoadId=663f4ef5-e01c-4f27-b4b0-8e3d72ebe77f&siteId=ouh4zj&page=2&resultsPerPage=72&bgfilter.ss_type=parent&bgfilter.ss_on_sale=1&bgfilter.collection_handle=sale&redirectResponse=full&noBeacon=true&ajaxCatalog=Snap&resultsFormat=native'
