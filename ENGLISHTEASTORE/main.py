...
write_filename = "final_englishteastore_" + date_now + ".csv"
...
def get_product_links(page):
	global urls
	url = f'https://www.englishteastore.com/collections/clearance?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('ul', id='product-grid').find_all('li', class_='grid__item'):
		urls.append('https://www.englishteastore.com'+item.find('a').get('href'))
