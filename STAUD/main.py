...
write_filename = "final_staud_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://staud.clothing/collections/sale?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('ul', class_='plp-grid').find_all('li'):
		urls.append('https://staud.clothing'+item.find('a')['href'])
