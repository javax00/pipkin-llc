...
write_filename = "final_allbirds_" + date_now + ".csv"
...
def get_product_links(page):
	# url = f'https://www.allbirds.com/collections/sale-womens?page={page}'
	url = f'https://www.allbirds.com/collections/sale-mens?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('div', class_='grid-flow-dense').find_all('div', class_='col-span-1'):
		urls.append(item.find('a')['href'].split('?')[0])
