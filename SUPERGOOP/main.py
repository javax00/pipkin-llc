...
write_filename = "final_supergoop_" + date_now + ".csv"
...
if __name__ == "__main__":
	...
	# stealth_sync(page)
	start_url = "https://supergoop.com/collections/all"
	page.goto(start_url, wait_until="load")
	input('Enter if done scrolling: ')

	try:
		soup = BeautifulSoup(page.content(), "html.parser")
		for item in soup.find('div', class_='lg:grid-cols-3').find_all('div', class_='max-w-[426px]'):
