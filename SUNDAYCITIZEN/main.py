...
write_filename = "final_sundaycitizen_" + date_now + ".csv"
...
if __name__ == "__main__":
	...
	for i in range(1, total_pages + 1):
		stealth_sync(page)
		start_url = "https://sundaycitizen.co/collections/sale?page=" + str(i)
		page.goto(start_url, wait_until="load")

		soup = BeautifulSoup(page.content(), "html.parser")
		for item in soup.find('div', class_='product-grid--loader').find_all('div', class_='product-item--borderless'):
			try:
				urls.append('https://sundaycitizen.co'+item.find('a')['href'])
			except:
				continue
