...
write_filename = "final_jackrogers_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://www.jackrogersusa.com/collections/sale?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	json_data = soup.find('script', id='availble-collection').get_text()
	json_data = json.loads(json_data)
	for url in json_data['products']:
		urls.append('https://www.jackrogersusa.com'+url['url'].replace('\\', ''))
