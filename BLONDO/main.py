...
write_filename = "final_blondo_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://blondo.com/collections/sale?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('div', class_='grid-link__container').find_all('div', class_='grid__-item'):
		urls.append('https://blondo.com'+item.find('a')['href'])
