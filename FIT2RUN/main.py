...
write_filename = "final_fit2run_" + date_now + ".csv"
...
def get_product_links(page):
	url = f'https://www.fit2run.com/collections/sale-footwear?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')

	for item in soup.find('div', class_='product-grid').find_all('product-block'):
		urls.append('https://www.fit2run.com'+item.find('a')['href'].split('?')[0])
