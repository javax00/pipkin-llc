...
write_filename = "final_mygiftstop_" + date_now + ".csv"
...
def get_product_links(page):
	global urls
	# url = f'https://www.mygiftstop.com/collections/hot-deals?page={page}'
	url = f'https://www.mygiftstop.com/collections/sales?page={page}'
	html = get_zenrows_html(url)
	soup = BeautifulSoup(html, 'html.parser')
	
	for product in soup.find('div', class_='product-list__inner').find_all('product-item', class_='product-item'):
		urls.append('https://www.mygiftstop.com'+product.find('a').get('href'))   
